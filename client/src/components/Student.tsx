...
const Student = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      const url = `${process.env.REACT_APP_BACKEND_URL}/students/courses/1`;
        ...
        <section className="flex gap-4">
          ...
          <section>
            ...
            {courses.map((course, i) => (
              <div
                key={i}
                className="flex justify-between gap-2 text-left mb-4 border border-black rounded px-8 py-4"
              >
                <div>
                  <div>
                    <span className="font-bold">ID: </span>
                ...
                <button
                  type="button"
                  className="border border-black rounded py-1 px-4 hover:bg-gray-400 cursor-pointer"
                >
                  Enroll
                </button>
              </div>
