...
class StudentService:
    ...
    def get_student_courses(student_id):
        try:
            ...
            if student:
                courses = Course.query.filter_by(course_id=student.course_id).all()
                if not courses:
    ...
    def enroll_student_in_course(student_id, course_id):
        try:
            ...
            if student and course and course_id:
                # Check if the student is already enrolled in the course
                existing_enrollment = Student.query.filter_by(student_id=student_id, course_id=course_id).first()
